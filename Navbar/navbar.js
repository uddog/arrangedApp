    ...
    try {
        ...
        if (rowIndex >= 1 && rowIndex < rows.length) {
            ...
            switch (additionalValue) {
                case '0':
                    addAdminButton('Search', 'https://uddog.github.io/arrangedApp/Admin/admin0.html'); // Set the link for Admin 1
                    addAdminButton('Udrita', 'https://kilt-bluefish.cyclic.app/'); // Set the link for Admin 1
                    break;
                case '1':
                    addAdminButton('Search', 'https://uddog.github.io/arrangedApp/Admin/admin0.html'); // Set the link for Admin 1
                    addAdminButton('Access', 'https://uddog.github.io/arrangedApp/Admin/admin1.html'); // Set the link for Admin 1
                    addAdminButton('Udrita', 'https://kilt-bluefish.cyclic.app/'); // Set the link for Admin 1
                    break;
                case '2':
                    addAdminButton('Search', 'https://uddog.github.io/arrangedApp/Admin/admin0.html'); // Set the link for Admin 1
                    addAdminButton('Access Pro', 'https://uddog.github.io/arrangedApp/Admin/admin2.html'); // Set the link for Admin 2
                    addAdminButton('Access', 'https://uddog.github.io/arrangedApp/Admin/admin1.html'); // Set the link for Admin 1
                    addAdminButton('Udrita', 'https://kilt-bluefish.cyclic.app/'); // Set the link for Admin 1
                    break;
                 case '3':
                    ...
                    addAdminButton('Access Pro', 'https://uddog.github.io/arrangedApp/Admin/admin2.html'); // Set the link for Admin 2
                    addAdminButton('Access', 'https://uddog.github.io/arrangedApp/Admin/admin1.html'); // Set the link for Admin 1
                    addAdminButton('Admin', 'https://uddog.github.io/arrangedApp/Admin/admin3.html'); // Set the link for Admin 1
                    addAdminButton('Udrita', 'https://kilt-bluefish.cyclic.app/'); // Set the link for Admin 1
                    break;
            ...
            switch (roleValue) {
                default:
                    addAdminButton(roleValue,'https://uddog.github.io/arrangedApp/profession.html'); // Use roleValue as button name and link to profession.html
                    break;
            }
